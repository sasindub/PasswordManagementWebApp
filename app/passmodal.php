  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <span style="color:red; font-size:14pt;">*</span> Category:
        ...
        <input type="password" class="inp" name="pass" id="pass" style=" border-radius: 5px; padding: 5px; width:100%; border: 1px solid white; background-color: #e6e6e8; margin-top:-1px;" placeholder="Password" required>
...
<label class="containerr">High
  ...
  <span class="checkmark"></span>
        ...
        <input type="hidden" name="cat" id="catt" value="0">
      </form>
      </div>
